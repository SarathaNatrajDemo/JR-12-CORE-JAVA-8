package com.demo.samples.assignments;
...
public class CalculatorSolution {
    ...
    public static void main(String[] args) {
        ...
        new CalculatorSolution().getValues(scan);
    ...
    public void getValues(Scanner scan) {
        ...
        do {
            ...
            String result=new CalculatorSolution().calculate(firstValue,secondValue,operator);
